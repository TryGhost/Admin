...
export default Service.extend(Evented, {
    ...
    init() {
        ...
        this.throbbers = [{
            ...
            message: `This is your admin area! You'll find all of your content, users, settings and you can also view your site right here. Can come back any time by visiting <a href="${adminUrl}" target="_blank">${adminDisplayUrl}</a>`
        }, {
            id: 'using-the-editor',
