...
Router.map(function () {
    ...
    this.route('settings.schedule', {path: '/settings/schedule'});
    this.route('settings.shows', {path: '/settings/shows'});
    this.route('settings.presenters', {path: '/settings/presenters'});
