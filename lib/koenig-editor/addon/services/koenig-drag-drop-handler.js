...
export default Service.extend({
    ...
    registerContainer(element, options) {
        console.log('registerContainer', element, options);
    ...
    _onMouseDown(event) {
        ...
        if (!this.isDragging && (event.button === undefined || event.button === 0)) {
            ...
            console.log('grabbedElement', this.grabbedElement);
    ...
    _onMouseUp(event) {
        ...
        // TODO: trigger drop actions on containers
    ...
    _waitForDragStart: task(function* (startEvent) {
        ...
        try {
            ...
            console.log('cleaning up _waitForDragStart');
