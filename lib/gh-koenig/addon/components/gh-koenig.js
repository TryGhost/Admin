    ...
    actions: {
        ...
        selectCard(cardId) {
            ...
            document.onclick = (event) => {
                ...
                console.log(target[0], parent[0]);
                if (!target.hasClass('kg-card') 
                && !target.hasClass('kg-card-button') 
                && !target.hasClass('kg-card-button-text') 
                && (!parent.length || parent[0] !== cardHolder[0])) {
                    console.log("11");
                    this.send('deselectCard');
                }
            };
